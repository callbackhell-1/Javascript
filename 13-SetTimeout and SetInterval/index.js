...
const personDetails1 = (name, age, salary) => {
  console.log(`my name is ${name} age is ${age} and salary is $${salary}`);
};

const passingId2 = setInterval(personDetails1, 4000, "Adarsh", 45, 500);

//   It will keep on repeating after every 4 sec

/*----------clearInterval------------- */

const btn = document.querySelector("button");
btn.addEventListener("click", () => {
  clearInterval(passingId2);
